        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <a href="<?php echo e(route('pengguna.cetak')); ?>" class="btn btn-sm btn-primary float-right">Cetak Pengguna</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <td>
                                <form action="<?php echo e(route('pengguna.destroy', $u->id)); ?>" method="POST">
                                    ...
                                    <a class="btn btn-sm btn-warning" href="<?php echo e(route('pengguna.edit', $u->id)); ?>">Edit</a>
...
, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\perpusb\resources\views/user/index.blade.php ENDPATH**/ ?>